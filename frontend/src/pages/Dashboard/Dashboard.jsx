...
const Dashboard = () => {
  ...
  const quickActions = [
    { name: 'View Calendar', path: '/dashboard/calendar', color: '#3b82f6' },
    { name: 'Add Client', path: '/dashboard/clients/create', color: '#10b981' },
    { name: 'Generate Invoice', path: '/dashboard/invoices/create', color: '#8b5cf6' },
    { name: 'Add Stay', path: '/dashboard/stays/create', color: '#f59e0b' },
  ]
