...
exports.createCity = [
  async (req, res) => {
    try {
      ...
      res.status(201).json({ 
        messageCode: 'MSG_0037', message: 'City created successfully',
        city: newCity
      });
    } catch (error) {
...
exports.updateCity = [
  async (req, res) => {
    try {
      ...
      res.json({ 
        messageCode: 'MSG_0039', message: 'City updated successfully',
        city
      });
    } catch (error) {
    ...
    try {
      ...
      if (zonesCount > 0) {
        return res.status(400).json({ 
          messageCode: 'MSG_0040', message: 'Cannot delete city with associated zones' 
        });
      }
      ...
      res.json({ 
        messageCode: 'MSG_0041', message: 'City deleted successfully'
      });
    } catch (error) {
